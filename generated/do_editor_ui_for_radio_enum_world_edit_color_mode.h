...
link_internal b32
DoEditorUi(renderer_2d *Ui, window_layout *Window, world_edit_color_mode *Element, cs Name, u32 ParentHash, ui_render_params *Params = &DefaultUiRenderParams_Generic, base_ptr_relative_edit_block_array *ChangeRecords = 0)
{
  b32 Result = False;
