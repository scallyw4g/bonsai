...
link_internal void
DoEditorUi(renderer_2d *Ui, window_layout *Window, shader_uniform_buffer *Container, cs Name, u32 ParentHash, ui_render_params *Params, primitive_value_changed_record_block_array *ChangeRecords )
{
  u32 ThisHash = ChrisWellonsIntegerHash_lowbias32(ParentHash ^ 0x1E4DB918);
