...
link_internal void
Insert( world_edit_ptr_block_array *Array, world_edit_ptr_block_array_index Index, world_edit_ptr Element )
{
  Assert(Index.Index <= LastIndex(Array).Index);
  Assert(Array->Memory);

  // Alocate a new thingy
  world_edit_ptr Prev = Push(Array);
...
link_internal void
Insert( world_edit_ptr_block_array *Array, u32 Index, world_edit_ptr Element )
{
