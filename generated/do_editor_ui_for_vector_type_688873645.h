...
DoEditorUi(renderer_2d *Ui, v4i *Value, cs Name, EDITOR_UI_FUNCTION_PROTO_DEFAULTS, EDITOR_UI_VALUE_RANGE_PROTO_DEFAULTS)
{
  ...
  if (Value)
  {
    ...
    PushTableStart(Ui);
    DoEditorUi(Ui, (r32*)&Value->E[0], {}, EDITOR_UI_FUNCTION_INSTANCE_NAMES, EDITOR_UI_VALUE_RANGE_INSTANCE_NAMES );
    DoEditorUi(Ui, (r32*)&Value->E[1], {}, EDITOR_UI_FUNCTION_INSTANCE_NAMES, EDITOR_UI_VALUE_RANGE_INSTANCE_NAMES );
    DoEditorUi(Ui, (r32*)&Value->E[2], {}, EDITOR_UI_FUNCTION_INSTANCE_NAMES, EDITOR_UI_VALUE_RANGE_INSTANCE_NAMES );
    DoEditorUi(Ui, (r32*)&Value->E[3], {}, EDITOR_UI_FUNCTION_INSTANCE_NAMES, EDITOR_UI_VALUE_RANGE_INSTANCE_NAMES );
    PushTableEnd(Ui);
    /* PushNewRow(Ui); */
    EndColumn(Ui, Start);
  }
