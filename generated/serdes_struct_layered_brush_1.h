// src/engine/serdes.cpp:571:0

link_internal bonsai_type_info
TypeInfo(layered_brush_1 *Ignored)
{
...
link_internal b32
Serialize(u8_cursor_block_array *Bytes, layered_brush_1 *BaseElement, umm Count = 1)
{
  Assert(Count > 0);
...
link_internal b32
Deserialize(u8_cursor *Bytes, layered_brush_1 *Element, memory_arena *Memory, umm Count = 1);
...
link_internal b32
Deserialize(u8_cursor *Bytes, layered_brush_1 *Element, memory_arena *Memory, umm Count)
{
  Assert(Count > 0);
