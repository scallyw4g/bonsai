...
link_inline void
CopyVertexBuffer( v3 *Dest, v3_u8 *Src, u32 NumVerts, v3 Offset, v3 Scale, Quaternion Rot)
{
  Assert(NumVerts % 3 == 0);
...
//
link_inline void
CopyVertexBuffer( v3 *Dest, v3_u8 *Src, u32 NumVerts, v3 Offset, v3 Scale )
{
  Assert(NumVerts % 3 == 0);
...
link_inline void
CopyVertexBuffer( v3 *Dest, v3_u8 *Src, u32 NumVerts )
{
