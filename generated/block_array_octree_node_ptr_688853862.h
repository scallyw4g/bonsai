...
{
  auto Result = TryGetPtr(Arr, octree_node_ptr_block_array_index{Index});
  return Result;
}
...
link_internal void
Insert( octree_node_ptr_block_array *Array, octree_node_ptr_block_array_index Index, octree_node_ptr Element )
{
  Assert(Index.Index <= LastIndex(Array).Index);
  Assert(Array->Memory);

  // Alocate a new thingy
  octree_node_ptr Prev = Push(Array);
...
link_internal void
Insert( octree_node_ptr_block_array *Array, u32 Index, octree_node_ptr Element )
{
...
link_internal octree_node_ptr 
Pop( octree_node_ptr_block_array *Array )
{
