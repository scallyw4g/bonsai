...
link_internal b32
Serialize(u8_cursor_block_array *Bytes, entity_block_array *BaseElement);

link_internal b32
Serialize(u8_cursor_block_array *Bytes, entity_block_array *BaseElement, umm Count);

link_internal b32
Deserialize(u8_cursor *Bytes, entity_block_array *Element, memory_arena *Memory);
...
link_internal b32
Serialize(u8_cursor_block_array *Bytes, world_edit_block_array *BaseElement);

link_internal b32
Serialize(u8_cursor_block_array *Bytes, world_edit_block_array *BaseElement, umm Count);

link_internal b32
Deserialize(u8_cursor *Bytes, world_edit_block_array *Element, memory_arena *Memory);
...
link_internal b32
Serialize(u8_cursor_block_array *Bytes, world_edit_layer_block_array *BaseElement);

link_internal b32
Serialize(u8_cursor_block_array *Bytes, world_edit_layer_block_array *BaseElement, umm Count);

link_internal b32
Deserialize(u8_cursor *Bytes, world_edit_layer_block_array *Element, memory_arena *Memory);
...
link_internal b32
Serialize(u8_cursor_block_array *Bytes, primitive_value_changed_record_block_array *BaseElement);

link_internal b32
Serialize(u8_cursor_block_array *Bytes, primitive_value_changed_record_block_array *BaseElement, umm Count);

link_internal b32
Deserialize(u8_cursor *Bytes, primitive_value_changed_record_block_array *Element, memory_arena *Memory);

link_internal b32
Deserialize(u8_cursor *Bytes, primitive_value_changed_record_block_array *Element, memory_arena *Memory, umm Count);

link_internal b32
DeserializeCurrentVersion(u8_cursor *Bytes, primitive_value_changed_record_block_array *Element, memory_arena *Memory);
