...
link_internal b32
Serialize( u8_cursor_block_array *Bytes, world_edit_block_array_index_block_array *Collection)
{
...
link_internal b32
Deserialize( u8_cursor *Bytes, world_edit_block_array_index_block_array *Collection, memory_arena *Memory)
{
