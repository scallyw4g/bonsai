// src/engine/serdes.cpp:516:0

link_internal b32
Deserialize(u8_cursor *Bytes, level_header_3 *Element, memory_arena *Memory, umm Count = 1);

link_internal b32
DeserializeCurrentVersion(u8_cursor *Bytes, level_header_3 *Element, memory_arena *Memory);
...
link_internal b32
Deserialize(u8_cursor *Bytes, level_header_3 *Element, memory_arena *Memory, umm Count)
{
  Assert(Count > 0);
