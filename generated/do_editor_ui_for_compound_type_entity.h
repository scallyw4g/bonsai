...
DoEditorUi(renderer_2d *Ui, entity *Element, const char* Name, EDITOR_UI_FUNCTION_PROTO_DEFAULTS)
{
  ...
  if (ToggleButton(Ui, CS(Name), CS(Name), umm(Element) ^ umm(Name), EDITOR_UI_FUNCTION_INSTANCE_NAMES))
  {
    ...
    DoEditorUi(Ui, &Element->RateOfFire, "r32 RateOfFire", EDITOR_UI_FUNCTION_INSTANCE_NAMES);
    DoEditorUi(Ui, &Element->FireCooldown, "r32 FireCooldown", EDITOR_UI_FUNCTION_INSTANCE_NAMES);
    DoEditorUi(Ui, &Element->Health, "s32 Health", EDITOR_UI_FUNCTION_INSTANCE_NAMES);
