...
link_internal b32
Serialize(u8_cursor_block_array *Bytes, world_update_op_shape_params_sphere *BaseElement, umm Count)
{
  Assert(Count > 0);
...
link_internal b32
Serialize(u8_cursor_block_array *Bytes, world_update_op_shape_params_sphere *BaseElement)
{
...
link_internal b32
Deserialize(u8_cursor *Bytes, world_update_op_shape_params_sphere *Element, memory_arena *Memory);
