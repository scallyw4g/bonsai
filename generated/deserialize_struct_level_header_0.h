link_internal b32
Deserialize(u8_stream *Bytes, level_header_0 *Element, memory_arena *Memory);

link_internal b32
DeserializeUnversioned(u8_stream *Bytes, level_header_0 *Element, memory_arena *Memory)
{
  b32 Result = True;
