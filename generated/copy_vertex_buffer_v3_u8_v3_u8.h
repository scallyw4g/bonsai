...
link_inline void
CopyVertexBuffer( v3_u8 *Dest, v3_u8 *Src, u32 NumVerts, v3 Offset, v3 Scale, Quaternion Rot)
{
  Assert(NumVerts % 3 == 0);
    ...
    VertIndex += 3 )
  {
    ...
    v3_u8 Result0 = {{ u8(Vert0.E[0]), u8(Vert0.E[1]), u8(Vert0.E[2]) }};
    v3_u8 Result1 = {{ u8(Vert1.E[0]), u8(Vert1.E[1]), u8(Vert1.E[2]) }};
    v3_u8 Result2 = {{ u8(Vert2.E[0]), u8(Vert2.E[1]), u8(Vert2.E[2]) }};
...
//
link_inline void
CopyVertexBuffer( v3_u8 *Dest, v3_u8 *Src, u32 NumVerts, v3 Offset, v3 Scale )
{
  Assert(NumVerts % 3 == 0);
...
link_inline void
CopyVertexBuffer( v3_u8 *Dest, v3_u8 *Src, u32 NumVerts )
{
  ...
  }
  {
      ...
      VertIndex += 3 )
    {
      ...
      Dest[VertIndex + 0] = V3U8(Src0);
      Dest[VertIndex + 1] = V3U8(Src1);
      Dest[VertIndex + 2] = V3U8(Src2);
    }
  }
}
