// src/engine/serdes.cpp:0:386

link_internal b32
Deserialize(u8_cursor *Bytes, level_header_1 *Element, memory_arena *Memory);

link_internal b32
DeserializeUnversioned(u8_cursor *Bytes, level_header_1 *Element, memory_arena *Memory)
{
  b32 Result = True;
