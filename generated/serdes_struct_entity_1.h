...
link_internal b32
Serialize(u8_cursor_block_array *Bytes, entity_1 *Element)
{
...
link_internal b32
DeserializeUnversioned(u8_cursor *Bytes, entity_1 *Element, memory_arena *Memory)
{
  b32 Result = True;
