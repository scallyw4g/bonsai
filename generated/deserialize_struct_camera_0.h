// src/engine/serdes.cpp:59:0

link_internal b32
Deserialize(u8_cursor *Bytes, camera_0 *Element, memory_arena *Memory, umm Count = 1);
...
link_internal b32
Deserialize(u8_cursor *Bytes, camera_0 *Element, memory_arena *Memory, umm Count)
{
  Assert(Count > 0);
