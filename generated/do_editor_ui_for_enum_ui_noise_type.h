// callsite
// src/engine/editor.h:424:0

// def (do_editor_ui_for_enum)
// external/bonsai_stdlib/src/poof_functions.h:3431:0
link_internal b32
DoEditorUi(renderer_2d *Ui, window_layout *Window, brush_noise_type *Element, cs Name, u32 ParentHash, ui_render_params *Params = &DefaultUiRenderParams_Generic, base_ptr_relative_edit_block_array *UiChangeEvents = 0)
{
  b32 Result = False;
