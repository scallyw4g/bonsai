...
link_internal b32
Serialize(u8_cursor_block_array *Bytes, rect3i *BaseElement, umm Count)
{
  Assert(Count > 0);
...
link_internal b32
Serialize(u8_cursor_block_array *Bytes, rect3i *BaseElement)
{
...
link_internal b32
Deserialize(u8_cursor *Bytes, rect3i *Element, memory_arena *Memory);
...
DeserializeCurrentVersion(u8_cursor *Bytes, rect3i *Element, memory_arena *Memory)
{
  ...
  if (ThisMember == False)
  {
    SoftError("Deserializing v3i Min on rect3i");
  }
  Result &= ThisMember;
  ThisMember = 3;
  ...
  if (ThisMember == False)
  {
    SoftError("Deserializing v3i Max on rect3i");
  }
  Result &= ThisMember;
