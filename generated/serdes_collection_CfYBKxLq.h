...
link_internal b32
Serialize( u8_cursor_block_array *Bytes, edit_record_block_array *Collection)
{
...
link_internal b32
Deserialize( u8_cursor *Bytes, edit_record_block_array *Collection, memory_arena *Memory)
{
