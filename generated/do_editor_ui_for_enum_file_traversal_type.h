// callsite
// src/engine/editor.cpp:543:0

// def (do_editor_ui_for_enum)
// src/engine/editor.h:751:0
link_internal b32
DoEditorUi(renderer_2d *Ui, window_layout *Window, file_traversal_type *Element, cs Name, u32 ParentHash, ui_render_params *Params = &DefaultUiRenderParams_Generic, primitive_value_changed_record_block_array *ChangeRecords = 0)
{
  b32 Result = False;
