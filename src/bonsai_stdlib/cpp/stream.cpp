...
//
// TODO(Jesse, tags: platform): Make this use platform agnostic functions!
u8_stream
...
{
  // TODO(Jesse, tags: robustness, cleanup): Make this return a counted string and everything that depends on
