          ...
          {
            Result.Max = Max(Result.Max, GetAbsoluteDrawBoundsMax(&Command->ui_render_command_button_start.Layout));
            Result.Min = Min(Result.Min, GetAbsoluteDrawBoundsMin(&Command->ui_render_command_button_start.Layout));
          } break;
