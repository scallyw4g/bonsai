      ...
      function void DebugPrint(debug_state S)
      {
          ...
          DebugPrint(S.GameState);

          DebugPrint("UiGroup");
          DebugPrint(S.UiGroup);

          DebugPrint("LineMesh");
          DebugPrint(S.LineMesh);
          ...
          DebugPrint("GameGeoFBO");
          DebugPrint(S.GameGeoFBO);
          ...
          DebugPrint("DebugGameGeoTextureShader");
          DebugPrint(S.DebugGameGeoTextureShader);

          DebugPrint("SelectedArenas");
          DebugPrint(S.SelectedArenas);

          DebugPrint("DoChunkPicking");
          DebugPrint(S.DoChunkPicking);

          DebugPrint("HotChunk");
          DebugPrint(S.HotChunk);

          DebugPrint("PickedChunks");
          DebugPrint(S.PickedChunks);

          DebugPrint("PickedChunkCount");
          DebugPrint(S.PickedChunkCount);

          DebugPrint("PickRay");
          DebugPrint(S.PickRay);

          DebugPrint("BytesBufferedToCard");
          DebugPrint(S.BytesBufferedToCard);

          DebugPrint("Initialized");
          DebugPrint(S.Initialized);

          DebugPrint("Debug_RedrawEveryPush");
          DebugPrint(S.Debug_RedrawEveryPush);

          DebugPrint("DebugDoScopeProfiling");
          DebugPrint(S.DebugDoScopeProfiling);

          DebugPrint("TriggerRuntimeBreak");
          DebugPrint(S.TriggerRuntimeBreak);

          DebugPrint("DisplayDebugMenu");
          DebugPrint(S.DisplayDebugMenu);

          DebugPrint("HotFunction");
          DebugPrint(S.HotFunction);

          DebugPrint("FreeScopeSentinel");
          DebugPrint(S.FreeScopeSentinel);

#if 0
          DebugPrint("FreeScopeMutex");
          DebugPrint(S.FreeScopeMutex);
#endif

          DebugPrint("Frames");
          DebugPrint(S.Frames);

          DebugPrint("ThreadStates");
          DebugPrint(S.ThreadStates);

          DebugPrint("ReadScopeIndex");
          DebugPrint(S.ReadScopeIndex);

          DebugPrint("FreeScopeCount");
          DebugPrint(S.FreeScopeCount);

          DebugPrint("NumScopes");
          DebugPrint(S.NumScopes);

          DebugPrint("RegisteredMemoryArenas");
          DebugPrint(S.RegisteredMemoryArenas);

#if 0
          DebugPrint("FrameEnd");
          DebugPrint(S.FrameEnd);

          DebugPrint("FrameBegin");
          DebugPrint(S.FrameBegin);

          DebugPrint("RegisterArena");
          DebugPrint(S.RegisterArena);

          DebugPrint("WorkerThreadAdvanceDebugSystem");
          DebugPrint(S.WorkerThreadAdvanceDebugSystem);

          DebugPrint("MainThreadAdvanceDebugSystem");
          DebugPrint(S.MainThreadAdvanceDebugSystem);

          DebugPrint("MutexWait");
          DebugPrint(S.MutexWait);

          DebugPrint("MutexAquired");
          DebugPrint(S.MutexAquired);

          DebugPrint("MutexReleased");
          DebugPrint(S.MutexReleased);

          DebugPrint("GetProfileScope");
          DebugPrint(S.GetProfileScope);

          DebugPrint("Debug_Allocate");
          DebugPrint(S.Debug_Allocate);

          DebugPrint("RegisterThread");
          DebugPrint(S.RegisterThread);

          DebugPrint("ClearMetaRecordsFor");
          DebugPrint(S.ClearMetaRecordsFor);

          DebugPrint("InitDebugSystem");
          DebugPrint(S.InitDebugSystem);

          DebugPrint("TrackDrawCall");
          DebugPrint(S.TrackDrawCall);

          DebugPrint("GetThreadLocalState");
          DebugPrint(S.GetThreadLocalState);

          DebugPrint("PickChunk");
          DebugPrint(S.PickChunk);

          DebugPrint("ComputePickRay");
          DebugPrint(S.ComputePickRay);

          DebugPrint("DebugValue");
          DebugPrint(S.DebugValue);

          DebugPrint("DumpScopeTreeDataToConsole");
          DebugPrint(S.DumpScopeTreeDataToConsole);

          DebugPrint("OpenDebugWindowAndLetUsDoStuff");
          DebugPrint(S.OpenDebugWindowAndLetUsDoStuff);
#endif
      }
...
#if 0
      // Source File : src/bonsai_stdlib/headers/mutex.h
      function void DebugPrint(mutex S)
      {
      ...
      function void DebugPrint(thing1 S)
      {
          ...
          DebugPrint("StringThing");
          DebugPrint(S.StringThing);
      ...
      function void DebugPrint(head_table S)
      {
          ...
          DebugPrint("Version");
          DebugPrint(S.Version);

          DebugPrint("FontRevision");
          DebugPrint(S.FontRevision);

          DebugPrint("ChecksumAdjustment");
          DebugPrint(S.ChecksumAdjustment);

          DebugPrint("MagicNumber");
          DebugPrint(S.MagicNumber);

          DebugPrint("Flags");
          DebugPrint(S.Flags);

          DebugPrint("UnitsPerEm");
          DebugPrint(S.UnitsPerEm);

          DebugPrint("Created");
          DebugPrint(S.Created);

          DebugPrint("Modified");
          DebugPrint(S.Modified);
          ...
          DebugPrint("MacStyle");
          DebugPrint(S.MacStyle);

          DebugPrint("LowestRecPPEM");
          DebugPrint(S.LowestRecPPEM);

          DebugPrint("FontDirectionHint");
          DebugPrint(S.FontDirectionHint);

          DebugPrint("IndexToLocFormat");
          DebugPrint(S.IndexToLocFormat);

          DebugPrint("GlyphDataFormat");
          DebugPrint(S.GlyphDataFormat);
      ...
      function void DebugPrint(ttf_contour S)
      {
          ...
          DebugPrint(S.StartIndex);

          DebugPrint("EndIndex");
          DebugPrint(S.EndIndex);
      ...
      function void DebugPrint(simple_glyph S)
      {
          ...
          DebugPrint("EmSpaceDim");
          DebugPrint(S.EmSpaceDim);

          DebugPrint("ContourCount");
          DebugPrint(S.ContourCount);

          DebugPrint("Contours");
          DebugPrint(S.Contours);
      ...
      function void DebugPrint(font_table S)
      {
          ...
          DebugPrint("HumanTag");
          DebugPrint(S.HumanTag);

          DebugPrint("Checksum");
          DebugPrint(S.Checksum);
      ...
      function void DebugPrint(ttf S)
      {
          ...
          DebugPrint("HeadTable");
          DebugPrint(S.HeadTable);
      ...
      function void DebugPrint(offset_subtable S)
      {
          ...
          DebugPrint("ScalerType");
          DebugPrint(S.ScalerType);

          DebugPrint("NumTables");
          DebugPrint(S.NumTables);

          DebugPrint("SearchRange");
          DebugPrint(S.SearchRange);

          DebugPrint("EntrySelector");
          DebugPrint(S.EntrySelector);

          DebugPrint("RangeShift");
          DebugPrint(S.RangeShift);
