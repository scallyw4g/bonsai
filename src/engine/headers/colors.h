...
static v4 DefaultPalette[] = {
  ...
  V4( 0xff, 0x33, 0x00, 0xff), // 30
  V4( 0xff, 0x00, 0xff, 0xff), // 31
  V4( 0xff, 0x00, 0xcc, 0xff), // 32
  V4( 0xff, 0x00, 0x99, 0xff), // 33
  V4( 0xff, 0x00, 0x66, 0xff), // 34
  V4( 0xff, 0x00, 0x33, 0xff), // 35
  V4( 0xff, 0x00, 0x00, 0xff), // 36
  ...
  V4( 0xcc, 0x33, 0x00, 0xff), // 66
  V4( 0xcc, 0x00, 0xff, 0xff), // 67
  V4( 0xcc, 0x00, 0xcc, 0xff), // 68
  V4( 0xcc, 0x00, 0x99, 0xff), // 69
  V4( 0xcc, 0x00, 0x66, 0xff), // 70
  V4( 0xcc, 0x00, 0x33, 0xff), // 71
  V4( 0xcc, 0x00, 0x00, 0xff), // 72
  ...
  V4( 0x99, 0x33, 0x00, 0xff), // 102
  V4( 0x99, 0x00, 0xff, 0xff), // 103
  V4( 0x99, 0x00, 0xcc, 0xff), // 104
  V4( 0x99, 0x00, 0x99, 0xff), // 105
  V4( 0x99, 0x00, 0x66, 0xff), // 106
  V4( 0x99, 0x00, 0x33, 0xff), // 107
  V4( 0x99, 0x00, 0x00, 0xff), // 108
  ...
  V4( 0x66, 0x33, 0x00, 0xff), // 138
  V4( 0x66, 0x00, 0xff, 0xff), // 139
  V4( 0x66, 0x00, 0xcc, 0xff), // 140
  V4( 0x66, 0x00, 0x99, 0xff), // 141
  V4( 0x66, 0x00, 0x66, 0xff), // 142
  V4( 0x66, 0x00, 0x33, 0xff), // 143
  V4( 0x66, 0x00, 0x00, 0xff), // 144
  ...
  V4( 0x33, 0x33, 0x00, 0xff), // 174
  V4( 0x33, 0x00, 0xff, 0xff), // 175
  V4( 0x33, 0x00, 0xcc, 0xff), // 176
  V4( 0x33, 0x00, 0x99, 0xff), // 177
  V4( 0x33, 0x00, 0x66, 0xff), // 178
  V4( 0x33, 0x00, 0x33, 0xff), // 179
  V4( 0x33, 0x00, 0x00, 0xff), // 180
  V4( 0x00, 0xff, 0xff, 0xff), // 181
  V4( 0x00, 0xff, 0xcc, 0xff), // 182
  V4( 0x00, 0xff, 0x99, 0xff), // 183
  V4( 0x00, 0xff, 0x66, 0xff), // 184
  V4( 0x00, 0xff, 0x33, 0xff), // 185
  V4( 0x00, 0xff, 0x00, 0xff), // 186
  V4( 0x00, 0xcc, 0xff, 0xff), // 187
  V4( 0x00, 0xcc, 0xcc, 0xff), // 188
  V4( 0x00, 0xcc, 0x99, 0xff), // 189
  V4( 0x00, 0xcc, 0x66, 0xff), // 190
  V4( 0x00, 0xcc, 0x33, 0xff), // 191
  V4( 0x00, 0xcc, 0x00, 0xff), // 192
  V4( 0x00, 0x99, 0xff, 0xff), // 193
  V4( 0x00, 0x99, 0xcc, 0xff), // 194
  V4( 0x00, 0x99, 0x99, 0xff), // 195
  V4( 0x00, 0x99, 0x66, 0xff), // 196
  V4( 0x00, 0x99, 0x33, 0xff), // 197
  V4( 0x00, 0x99, 0x00, 0xff), // 198
  V4( 0x00, 0x66, 0xff, 0xff), // 199
  V4( 0x00, 0x66, 0xcc, 0xff), // 200
  V4( 0x00, 0x66, 0x99, 0xff), // 201
  V4( 0x00, 0x66, 0x66, 0xff), // 202
  V4( 0x00, 0x66, 0x33, 0xff), // 203
  V4( 0x00, 0x66, 0x00, 0xff), // 204
  V4( 0x00, 0x33, 0xff, 0xff), // 205
  V4( 0x00, 0x33, 0xcc, 0xff), // 206
  V4( 0x00, 0x33, 0x99, 0xff), // 207
  V4( 0x00, 0x33, 0x66, 0xff), // 208
  V4( 0x00, 0x33, 0x33, 0xff), // 209
  V4( 0x00, 0x33, 0x00, 0xff), // 210
  V4( 0x00, 0x00, 0xff, 0xff), // 211
  V4( 0x00, 0x00, 0xcc, 0xff), // 212
  V4( 0x00, 0x00, 0x99, 0xff), // 213
  V4( 0x00, 0x00, 0x66, 0xff), // 214
  V4( 0x00, 0x00, 0x33, 0xff), // 215
  V4( 0xee, 0x00, 0x00, 0xff), // 216
  V4( 0xdd, 0x00, 0x00, 0xff), // 217
  V4( 0xbb, 0x00, 0x00, 0xff), // 218
  V4( 0xaa, 0x00, 0x00, 0xff), // 219
  V4( 0x88, 0x00, 0x00, 0xff), // 220
  V4( 0x77, 0x00, 0x00, 0xff), // 221
  V4( 0x55, 0x00, 0x00, 0xff), // 222
  V4( 0x44, 0x00, 0x00, 0xff), // 223
  V4( 0x22, 0x00, 0x00, 0xff), // 224
  V4( 0x11, 0x00, 0x00, 0xff), // 225
  V4( 0x00, 0xee, 0x00, 0xff), // 226
  V4( 0x00, 0xdd, 0x00, 0xff), // 227
  V4( 0x00, 0xbb, 0x00, 0xff), // 228
  V4( 0x00, 0xaa, 0x00, 0xff), // 229
  V4( 0x00, 0x88, 0x00, 0xff), // 230
  V4( 0x00, 0x77, 0x00, 0xff), // 231
  V4( 0x00, 0x55, 0x00, 0xff), // 232
  V4( 0x00, 0x44, 0x00, 0xff), // 233
  V4( 0x00, 0x22, 0x00, 0xff), // 234
  V4( 0x00, 0x11, 0x00, 0xff), // 235
  V4( 0x00, 0x00, 0xee, 0xff), // 236
  V4( 0x00, 0x00, 0xdd, 0xff), // 237
  V4( 0x00, 0x00, 0xbb, 0xff), // 238
  V4( 0x00, 0x00, 0xaa, 0xff), // 239
  V4( 0x00, 0x00, 0x88, 0xff), // 240
  V4( 0x00, 0x00, 0x77, 0xff), // 241
  V4( 0x00, 0x00, 0x55, 0xff), // 242
  V4( 0x00, 0x00, 0x44, 0xff), // 243
  V4( 0x00, 0x00, 0x22, 0xff), // 244
  V4( 0x00, 0x00, 0x11, 0xff), // 245
