...
// TODO(Jesse, allocation, speed): Why are these allocated on the heap?  Seems unnecessary..
texture *
...
MakeTexture_RGBA(v2i Dim, u32* Data, memory_arena *Mem, u32 MaxTextureSlices = 1)
{
  ...
  {
    // TODO(Jesse, robustness, open_question): This _should_ be able to be glTexImage3D, but the driver is
...
MakeTexture_RGB(v2i Dim, const v3* Data, memory_arena *Mem)
{
  ...
  // TODO(Jesse, opengl, memory_consumption): 32F is only necessary for reprojection of Position for
