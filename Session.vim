...
nmap <silent> ,s :w
nmap <silent> ,S :wa:mksession!
nmap <silent> ,es :UltiSnipsEdit
nmap <silent> ,ep :e ~/.config/lemonbar/panel
nmap <silent> ,ex :e ~/.Xresources
nmap <silent> ,eh :e ~/.config/sxhkd/sxhkdrc
nmap <silent> ,eb :e ~/.config/bspwm/bspwmrc
nmap <silent> ,ez :e ~/.zshrc
nmap <silent> ,ev :e ~/.vimrc
...
map <F6> :Mvn clean package:Java
vmap <F9> <Plug>ToggleBackground
nmap <F9> <Plug>ToggleBackground
map <F5> :Mvn clean package
...
set shortmess=aoO
badd +28 src/game.cpp
badd +4 src/game.h
badd +15 make.sh
badd +24 src/constants.hpp
badd +894 /usr/include/GL/glew.h
badd +1 src/controls.cpp
badd +8 src/math.h
badd +10 src/ogl_render.cpp
argglobal
silent! argdel *
edit src/game.cpp
