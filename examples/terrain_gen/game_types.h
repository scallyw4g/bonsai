...
enum terrain_gen_type
{
  ...
  TerrainGenType_GrassyTerracedTerrain      = (1 << 6),
  TerrainGenType_GrassyLargeTerracedTerrain = (1 << 7),
  TerrainGenType_GrassyTerracedTerrain2     = (1 << 8),
  TerrainGenType_GrassyIsland               = (1 << 9),
  TerrainGenType_Hoodoo                     = (1 << 10),
  TerrainGenType_Warped                     = (1 << 11),
};
